...
const lolApiVersion =
  process.env.NEXT_PUBLIC_LEAGUE_OF_LEGENDS_API_VERSION ?? "15.15.1";
...
export const getChampionSplashImageURL = (
  championId: string,
  skinId: number
) => {
...
export const getChampionAbilityVideoURL = (
  championKey: string,
...
export const getChampionRoleIcon = (
  role: string,
...
export const getChampionDifficultyIcon = (
  difficulty: number,
  props?: { [key: string]: string }
) => {
