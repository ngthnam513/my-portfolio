...
import { Environment, Float, OrbitControls, PerspectiveCamera, shaderMaterial, Sparkles, Stars, useTexture } from '@react-three/drei';
...
const myGirlImgs = Array.from({ length: TOTAL_NUMBERED_PHOTOS }, (_, i) => `/images/christmas/${i + 1}.jpg`);
const bodyPhotoPaths = ['/images/christmas/top.jpg', ...myGirlImgs, ...myGirlImgs, ...myGirlImgs];
...
export default function GrandTreeApp() {
    ...
    return (
        <div style={{ width: '100%', height: '100svh', backgroundColor: '#000', position: 'relative', overflow: 'hidden' }}>
            ...
            >
                <div style={{ marginBottom: '15px' }}>
                    ...
                    <p style={{ fontSize: '24px', color: '#FFD700', fontWeight: 'bold', margin: 0 }}>
                        ...
                        <span style={{ fontSize: '10px', color: '#555', fontWeight: 'normal' }}>POLAROIDS</span>
                    </p>
                </div>
                <div>
                    ...
                    <p style={{ fontSize: '24px', color: '#004225', fontWeight: 'bold', margin: 0 }}>
                        ...
                        <span style={{ fontSize: '10px', color: '#555', fontWeight: 'normal' }}>EMERALD NEEDLES</span>
                    </p>
                </div>
            </div>
